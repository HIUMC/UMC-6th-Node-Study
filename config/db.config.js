...
export const pool = mysql.createPool({
    host: process.env.DB_HOST || 'limdodb.cb0wia8um8qo.ap-northeast-2.rds.amazonaws.com',  // mysql의 hostname
    user: process.env.DB_USER || 'root',  // user 이름
    port: process.env.DB_PORT || 3306,  // 포트 번호
    database: process.env.DB_TABLE || 'umc_9',  // 데이터베이스 이름
    password: process.env.DB_PASSWORD || 'rosalim0829',  // 비밀번호
